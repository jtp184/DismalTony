DismalTony.create_handler(DismalTony::RemoteControl) do
  def handler_start
    @handler_name = 'git-project'
    @actions = ['push_project', 'push_deploy_project', 'push_version_project', 'version_push_deploy_project', 'list_projects', 'add_project']
  end
