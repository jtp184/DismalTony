module DismalTony # :nodoc:
  ...
  class Directive
    ...
    def initialize(qry, vi)
      @name = (self.class.public_send(:name) || '')
      @group = (self.class.public_send(:group) || 'none')
      @fragments = (self.class.public_send(:default_frags)&.clone || {})
      @match_criteria = (self.class.public_send(:match_criteria) || [])
      @query = qry
      @vi = vi
    end
